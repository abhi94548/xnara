...
class ImageUploadViewModel extends ChangeNotifier {
  late Map<String, dynamic> responseList = <String, dynamic>{};
  late bool successUpload = false;
  String category = '';

  Future<Map<String, dynamic>?> fetchPredictions(String imagePath) async {
    final Map<String, dynamic> _foodList =
        await WebServiceFoodApi().fetchFoodList();
    final Map<String, dynamic> _list =
        await WebServiceImageUpload().imageUpload(imagePath);
